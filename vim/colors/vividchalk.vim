...
function! s:hibg(group,guibg,first,second)
    ...
    exe "highlight ".a:group." guibg=".a:guibg." ctermbg=NONE
endfunction
...
highlight StatusLine    guifg=Black   guibg=#aabbee gui=bold ctermfg=None ctermbg=White  cterm=bold
highlight StatusLineNC  guifg=#444444 guibg=#aaaaaa gui=none ctermfg=None ctermbg=Grey   cterm=none
"if &t_Co == 256
